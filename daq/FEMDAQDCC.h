...
public:
  ...
  DCCPacket::packetReply SendCommand(const char* cmd, FEMProxy &FEM, DCCPacket::packetType type = DCCPacket::packetType::ASCII, size_t nPackets = 0, DCCPacket::packetDataType dataType = DCCPacket::packetDataType::NONE);
  void waitForTrigger();
